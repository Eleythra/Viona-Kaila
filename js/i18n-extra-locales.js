...
(function () {
  ...
  var PATCH = {
    ru: {
      ...
      gateRoomPlaceholder: "Укажите только номер комнаты.",
      gateRoomInputPlaceholder: "Номер",
      gateBirthDateLabel: "Дата рождения",
      ...
      gateErrorPassword: "Код не подтверждён. Проверьте и повторите.",
      gateErrorPasswordEmpty: "Введите код доступа.",
      gateScreenSubtitlePassword:
        "Введите код, прочитайте уведомление и подтвердите.",
      gatePasswordSingleLabel: "Код доступа",
      gatePasswordSingleHint: "Подойдёт любой код отеля; регистр не важен.",
      gatePasswordSinglePlaceholder: "Код",
      ...
      alacarteTerraceMenusTitle: "La Terrace · меню PDF",
      alacarteTerraceMenuTurkishCta: "Турецкая кухня",
      alacarteTerraceMenuTurkishAria: "Скачать меню турецкой кухни La Terrace (PDF, English)",
      alacarteTerraceMenuItalianCta: "Итальянская кухня",
      alacarteTerraceMenuItalianAria: "Скачать меню итальянской кухни La Terrace (PDF, English)",
    ...
    da: {
      ...
      gateRoomPlaceholder: "Angiv kun dit værelsesnummer.",
      gateRoomInputPlaceholder: "Værelse",
      gateBirthDateLabel: "Fødselsdato",
      ...
      gateErrorPassword: "Koden kunne ikke bekræftes. Prøv igen.",
      gateErrorPasswordEmpty: "Indtast adgangskoden.",
      gateScreenSubtitlePassword:
        "Indtast kode, læs meddelelsen og bekræft.",
      gatePasswordSingleLabel: "Adgangskode",
      gatePasswordSingleHint: "En kode fra hotellet er nok; store og små bogstaver er ligegyldige.",
      gatePasswordSinglePlaceholder: "Kode",
      ...
      alacarteTerraceMenusTitle: "La Terrace · PDF-menuer",
      alacarteTerraceMenuTurkishCta: "Tyrkisk køkken",
      alacarteTerraceMenuTurkishAria: "Download La Terrace-menu for tyrkisk køkken (PDF, English)",
      alacarteTerraceMenuItalianCta: "Italiensk køkken",
      alacarteTerraceMenuItalianAria: "Download La Terrace-menu for italiensk køkken (PDF, English)",
    ...
    cs: {
      ...
      gateRoomPlaceholder: "Zadejte pouze číslo pokoje.",
      gateRoomInputPlaceholder: "Pokoj",
      gateBirthDateLabel: "Datum narození",
      ...
      gateErrorPassword: "Kód nelze ověřit. Zkuste to znovu.",
      gateErrorPasswordEmpty: "Zadejte přístupový kód.",
      gateScreenSubtitlePassword:
        "Zadejte kód, přečtěte informaci a potvrďte.",
      gatePasswordSingleLabel: "Přístupový kód",
      gatePasswordSingleHint: "Stačí jeden kód od hotelu; na velikosti písmen nezáleží.",
      gatePasswordSinglePlaceholder: "Kód",
      ...
      alacarteTerraceMenusTitle: "La Terrace · PDF menu",
      alacarteTerraceMenuTurkishCta: "Turecká kuchyně",
      alacarteTerraceMenuTurkishAria: "Stáhnout menu turecké kuchyně La Terrace (PDF, angličtina)",
      alacarteTerraceMenuItalianCta: "Italská kuchyně",
      alacarteTerraceMenuItalianAria: "Stáhnout menu italské kuchyně La Terrace (PDF, angličtina)",
    ...
    ro: {
      ...
      gateRoomPlaceholder: "Introduceți doar numărul camerei.",
      gateRoomInputPlaceholder: "Cameră",
      gateBirthDateLabel: "Data nașterii",
      ...
      gateErrorPassword: "Codul nu a putut fi verificat. Încercați din nou.",
      gateErrorPasswordEmpty: "Introduceți codul de acces.",
      gateScreenSubtitlePassword:
        "Introduceți codul, citiți informarea și confirmați.",
      gatePasswordSingleLabel: "Cod de acces",
      gatePasswordSingleHint: "Orice cod de la hotel; nu contează literele mari sau mici.",
      gatePasswordSinglePlaceholder: "Cod",
      ...
      alacarteTerraceMenusTitle: "La Terrace · Meniuri PDF",
      alacarteTerraceMenuTurkishCta: "Bucătărie turcească",
      alacarteTerraceMenuTurkishAria: "Descărcați meniul bucătăriei turcești La Terrace (PDF, în engleză)",
      alacarteTerraceMenuItalianCta: "Bucătărie italiană",
      alacarteTerraceMenuItalianAria: "Descărcați meniul bucătăriei italiene La Terrace (PDF, în engleză)",
    ...
    nl: {
      ...
      gateRoomPlaceholder: "Vul alleen uw kamernummer in.",
      gateRoomInputPlaceholder: "Kamer",
      gateBirthDateLabel: "Geboortedatum",
      gateBirthDayShort: "Dag",
      ...
      gateErrorPassword: "De code kon niet worden geverifieerd. Probeer opnieuw.",
      gateErrorPasswordEmpty: "Voer de toegangscode in.",
      gateScreenSubtitlePassword:
        "Voer de code in, lees de mededeling en bevestig.",
      gatePasswordSingleLabel: "Toegangscode",
      gatePasswordSingleHint: "Eén hotelcode volstaat; hoofdletters doen er niet toe.",
      ...
      alacarteTerraceMenusTitle: "La Terrace · PDF-menu's",
      alacarteTerraceMenuTurkishCta: "Turkse keuken",
      alacarteTerraceMenuTurkishAria: "La Terrace-menu Turkse keuken downloaden (PDF, Engels)",
      alacarteTerraceMenuItalianCta: "Italiaanse keuken",
      alacarteTerraceMenuItalianAria: "La Terrace-menu Italiaanse keuken downloaden (PDF, Engels)",
    ...
    sk: {
      ...
      gateRoomPlaceholder: "Zadajte iba číslo izby.",
      gateRoomInputPlaceholder: "Izba",
      gateBirthDateLabel: "Dátum narodenia",
      ...
      gateErrorPassword: "Kód sa nepodarilo overiť. Skúste znova.",
      gateErrorPasswordEmpty: "Zadajte prístupový kód.",
      gateScreenSubtitlePassword:
        "Zadajte kód, prečítajte informáciu a potvrďte.",
      gatePasswordSingleLabel: "Prístupový kód",
      gatePasswordSingleHint: "Stačí jeden kód od hotela; veľkosť písmen nehrá rolu.",
      gatePasswordSinglePlaceholder: "Kód",
      ...
      alacarteTerraceMenusTitle: "La Terrace · PDF menu",
      alacarteTerraceMenuTurkishCta: "Turecká kuchyňa",
      alacarteTerraceMenuTurkishAria: "Stiahnuť menu tureckej kuchyne La Terrace (PDF, angličtina)",
      alacarteTerraceMenuItalianCta: "Talianska kuchyňa",
      alacarteTerraceMenuItalianAria: "Stiahnuť menu talianskej kuchyne La Terrace (PDF, angličtina)",
      modBeach: "Pláž a bazény",
