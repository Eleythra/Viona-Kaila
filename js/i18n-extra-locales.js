...
(function () {
  ...
  var PATCH = {
    ru: {
      ...
      gateErrorPassword: "Коды не совпадают. Проверьте и повторите.",
      gateErrorPasswordEmpty: "Введите первый код.",
      gateErrorPassword2Empty: "Введите также второй код доступа.",
      gateScreenSubtitleDualPassword:
        "Введите оба кода; прочитайте уведомление и подтвердите. Коды выдают на ресепшене или в Guest Relations.",
      gateDualPasswordLead: "Безопасный вход: оба кода полностью в этой сессии.",
      gatePasswordPrimaryLabel: "Первый код",
      gatePasswordPrimaryHint: "Код с ресепшена или Guest Relations — без изменений.",
      gatePasswordPrimaryPlaceholder: "Первый код",
      gatePasswordSecondaryLabel: "Второй код",
      gatePasswordSecondaryHint: "Второй код отеля — точно так, как выдан.",
      gatePasswordSecondaryPlaceholder: "Второй код",
      gateOptionalSectionKicker: "Учёт",
      gateOptionalLogLead: "Вход только по кодам. Имя и номер — по желанию для внутреннего учёта.",
      gateOptionalFullNameLabel: "Имя и фамилия",
      gateOptionalFullNameHint: "Без сверки с бронированием.",
      gateOptionalFullNamePlaceholder: "Иван Иванов",
      gateOptionalRoomLabel: "Номер",
      gateOptionalRoomHint: "Необязательно; без проверки.",
    ...
    da: {
      ...
      gateErrorPasswordEmpty: "Enter the first code.",
      gateErrorPassword2Empty: "Indtast også den anden adgangskode.",
      gateScreenSubtitleDualPassword:
        "Enter both codes, read the notice, then confirm. Codes are issued at the Front Office or Guest Relations.",
      gateDualPasswordLead: "Secure access: enter both codes in full during this session.",
      gatePasswordPrimaryLabel: "First code",
      gatePasswordPrimaryHint: "Type the Front Office or Guest Relations code exactly as given.",
    ...
    cs: {
      ...
      gateErrorPassword: "Codes do not match. Check and try again.",
      gateErrorPasswordEmpty: "Enter the first code.",
      gateErrorPassword2Empty: "Zadejte také druhý přístupový kód.",
      gateScreenSubtitleDualPassword:
        "Enter both codes, read the notice, then confirm. Codes are issued at the Front Office or Guest Relations.",
      gateDualPasswordLead: "Secure access: enter both codes in full during this session.",
      gatePasswordPrimaryLabel: "First code",
    ...
    ro: {
      ...
      gateErrorPassword: "Codes do not match. Check and try again.",
      gateErrorPasswordEmpty: "Enter the first code.",
      gateErrorPassword2Empty: "Introduceți și al doilea cod de acces.",
      gateScreenSubtitleDualPassword:
        "Enter both codes, read the notice, then confirm. Codes are issued at the Front Office or Guest Relations.",
      gateDualPasswordLead: "Secure access: enter both codes in full during this session.",
      gatePasswordPrimaryLabel: "First code",
    ...
    nl: {
      ...
      gateErrorPassword: "Codes do not match. Check and try again.",
      gateErrorPasswordEmpty: "Enter the first code.",
      gateErrorPassword2Empty: "Voer ook het tweede toegangscode in.",
      gateScreenSubtitleDualPassword:
        "Enter both codes, read the notice, then confirm. Codes are issued at the Front Office or Guest Relations.",
      gateDualPasswordLead: "Secure access: enter both codes in full during this session.",
      gatePasswordPrimaryLabel: "First code",
    ...
    sk: {
      ...
      gateErrorPassword: "Codes do not match. Check and try again.",
      gateErrorPasswordEmpty: "Enter the first code.",
      gateErrorPassword2Empty: "Zadajte aj druhý prístupový kód.",
      gateScreenSubtitleDualPassword:
        "Enter both codes, read the notice, then confirm. Codes are issued at the Front Office or Guest Relations.",
      gateDualPasswordLead: "Secure access: enter both codes in full during this session.",
      gatePasswordPrimaryLabel: "First code",
