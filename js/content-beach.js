(function () {
  ...
  var BEACH_KV = [
    { label: { tr: "Plaj mesafesi", en: "Distance to beach", de: "Strandentfernung", pl: "Odległość do plaży" }, value: "50 m" },
    { label: { tr: "Plaj konumu", en: "Beach position", de: "Lage", pl: "Położenie plaży" }, value: { tr: "1. sıra · otele çok yakın", en: "First line · very close", de: "Erste Reihe", pl: "Pierwsza linia · bardzo blisko hotelu" } },
    { label: { tr: "Plaj türü", en: "Beach type", de: "Strandart", pl: "Rodzaj plaży" }, value: { tr: "Kum ve çakıl", en: "Sand & pebble", de: "Sand & Kies", pl: "Piasek i żwir" } },
    { label: { tr: "Plaj statüsü", en: "Beach status", de: "Status", pl: "Status plaży" }, value: { tr: "Otelin özel plajı", en: "Hotel private beach", de: "Hotelprivatstrand", pl: "Prywatna plaża hotelu" } },
    { label: { tr: "Kullanım saatleri", en: "Hours", de: "Zeiten", pl: "Godziny" }, value: "08:30 – 18:30" },
    { label: { tr: "Plaj havlusu", en: "Beach towels", de: "Strandtücher", pl: "Ręczniki plażowe" }, value: { tr: "Ücretsiz", en: "Free", de: "Kostenlos", pl: "Bezpłatnie" } },
    { label: { tr: "Şemsiye", en: "Parasols", de: "Schirme", pl: "Parasole" }, value: { tr: "Ücretsiz", en: "Free", de: "Kostenlos", pl: "Bezpłatnie" } },
    { label: { tr: "Şezlong", en: "Sun loungers", de: "Liegen", pl: "Leżaki" }, value: { tr: "Ücretsiz", en: "Free", de: "Kostenlos", pl: "Bezpłatnie" } },
    ...
    { label: { tr: "Pavilion", en: "Pavilion", de: "Pavillon", pl: "Pawilon" }, value: { tr: "Yoktur", en: "Not available", de: "Nein", pl: "Brak" } },
    { label: { tr: "Otel–plaj erişimi", en: "Hotel–beach access", de: "Zugang", pl: "Dojście hotel–plaża" }, value: { tr: "Alt geçit", en: "Underpass", de: "Unterführung", pl: "Przejście podziemne" } },
    { label: { tr: "Beach Imbiss içecek", en: "Beach Imbiss drinks", de: "Beach Imbiss Getränke", pl: "Beach Imbiss — napoje" }, value: "10:00 – 17:00" },
    { label: { tr: "Beach Imbiss yiyecek", en: "Beach Imbiss food", de: "Beach Imbiss Essen", pl: "Beach Imbiss — jedzenie" }, value: "12:00 – 16:00" },
    {
      label: { tr: "İçecek seçenekleri", en: "Drinks", de: "Getränke", pl: "Napoje" },
      value: {
        ...
        pl: "Piwo, herbata, kawa, soki, napoje gazowane, woda, ajran",
      },
    },
    {
      label: { tr: "Yiyecek seçenekleri", en: "Food", de: "Essen", pl: "Jedzenie" },
      value: {
  ...
  var POOLS = [
    {
      ...
      tag: { tr: "Dinlenme havuzu", en: "Relaxation pool", de: "Ruhepool", pl: "Basen relaksacyjny" },
      kv: [
        { label: { tr: "Havuz türü", en: "Type", de: "Typ", pl: "Typ" }, value: { tr: "Açık havuz", en: "Outdoor", de: "Außen", pl: "Na zewnątrz" } },
        { label: { tr: "Su türü", en: "Water", de: "Wasser", pl: "Woda" }, value: { tr: "Tatlı su", en: "Fresh water", de: "Süßwasser", pl: "Woda słodka" } },
        { label: { tr: "Hacim", en: "Volume", de: "Volumen", pl: "Pojemność" }, value: "560 m³" },
        { label: { tr: "Kullanım saatleri", en: "Hours", de: "Zeiten", pl: "Godziny" }, value: "08:30 – 18:30" },
        { label: { tr: "Derinlik", en: "Depth", de: "Tiefe", pl: "Głębokość" }, value: "140 cm (1,4 m)" },
      ],
    },
    {
      img: "assets/images/beach/aquapark-64349b4a-d920-4b2d-88bf-d95de9a38d1b.png",
      title: { tr: "Aquapark / Activity Pool", en: "Aquapark / Activity Pool", de: "Aquapark", pl: "Aquapark / basen aktywności" },
      tag: { tr: "Eğlence & aquapark", en: "Fun & aquapark", de: "Spaß & Rutschen", pl: "Zabawa i aquapark" },
      kv: [
        { label: { tr: "Havuz türü", en: "Type", de: "Typ", pl: "Typ" }, value: { tr: "Açık havuz", en: "Outdoor", de: "Außen", pl: "Na zewnątrz" } },
        { label: { tr: "Su türü", en: "Water", de: "Wasser", pl: "Woda" }, value: { tr: "Tatlı su", en: "Fresh water", de: "Süßwasser", pl: "Woda słodka" } },
        { label: { tr: "Hacim", en: "Volume", de: "Volumen", pl: "Pojemność" }, value: "550 m³" },
        { label: { tr: "Aquapark", en: "Aquapark", de: "Aquapark", pl: "Aquapark" }, value: { tr: "Var", en: "Yes", de: "Ja", pl: "Tak" } },
        { label: { tr: "Yetişkin kaydırak", en: "Adult slides", de: "Rutschen Erw.", pl: "Zjeżdżalnie dla dorosłych" }, value: "3" },
        { label: { tr: "Çocuk kaydırak", en: "Kids’ slide", de: "Kinder-Rutsche", pl: "Zjeżdżalnia dla dzieci" }, value: "1" },
        {
          label: { tr: "Aquapark saatleri", en: "Aquapark hours", de: "Aquapark-Zeiten", pl: "Godziny aquaparku" },
    ...
    },
    {
      ...
      tag: { tr: "Dolphin havuz", en: "Dolphin pool", de: "Dolphin-Becken", pl: "Basen Dolphin" },
      kv: [
        { label: { tr: "Havuz türü", en: "Type", de: "Typ", pl: "Typ" }, value: { tr: "Açık havuz", en: "Outdoor", de: "Außen", pl: "Na zewnątrz" } },
        { label: { tr: "Su türü", en: "Water", de: "Wasser", pl: "Woda" }, value: { tr: "Tatlı su", en: "Fresh water", de: "Süßwasser", pl: "Woda słodka" } },
        { label: { tr: "Hacim", en: "Volume", de: "Volumen", pl: "Pojemność" }, value: "125 m³" },
        {
          label: { tr: "Kullanım saatleri", en: "Hours", de: "Zeiten", pl: "Godziny" },
          value: "08:30 – 18:30",
        },
      ],
    },
    {
      ...
      title: { tr: "Indoor Pool (Spa)", en: "Indoor Pool (Spa)", de: "Hallenbad (Spa)", pl: "Basen kryty (spa)" },
      tag: { tr: "Kapalı · ısıtmalı · 12 m", en: "Indoor · heated · 12 m", de: "Hallenbad · beheizt · 12 m", pl: "Kryty · podgrzewany · 12 m" },
      kv: [
        { label: { tr: "Havuz türü", en: "Type", de: "Typ", pl: "Typ" }, value: { tr: "Kapalı havuz", en: "Indoor", de: "Hallenbad", pl: "Kryty" } },
        { label: { tr: "Su türü", en: "Water", de: "Wasser", pl: "Woda" }, value: { tr: "Tatlı su", en: "Fresh water", de: "Süßwasser", pl: "Woda słodka" } },
        { label: { tr: "Uzunluk", en: "Length", de: "Länge", pl: "Długość" }, value: "12 m" },
        { label: { tr: "Kullanım saatleri", en: "Hours", de: "Zeiten", pl: "Godziny" }, value: "08:00 – 19:00" },
      ],
    },
    {
      img: "assets/images/beach/_ocukhavuzu-7c4e7f00-8a93-4633-917a-cdb1a596b1c6.png",
      title: { tr: "Çocuk havuzu", en: "Kids’ pool", de: "Kinderbecken", pl: "Brodzik / basen dla dzieci" },
      tag: { tr: "Güvenli sığ alan", en: "Shallow & safe", de: "Flach & sicher", pl: "Płytko i bezpiecznie" },
      kv: [
        {
          label: { tr: "Açıklama", en: "Description", de: "Beschreibung", pl: "Opis" },
          value: {
