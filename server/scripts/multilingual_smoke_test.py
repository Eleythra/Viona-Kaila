...
def main() -> None:
    ...
    cases: list[tuple[str, str, str, str | None, list[str]]] = [
        ...
        ("мне нужно полотенце", "ru", "ru", "RU request", ["intent:request", "lang:ru"]),
        ...
        ("я вегетарианец", "ru", "ru", "RU special", ["intent:special_need", "lang:ru"]),
        ...
        ("привет как дела", "ru", "ru", "RU chitchat", ["intent:chitchat", "lang:ru"]),
