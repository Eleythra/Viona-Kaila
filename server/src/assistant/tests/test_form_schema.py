...
from assistant.services.form_schema import (  # noqa: E402
    ...
    assert_complaint_chat_schema_invariants,
    assert_fault_chat_schema_invariants,
...
def test_fault_chat_schema_invariants():
    assert_fault_chat_schema_invariants()


def test_complaint_chat_schema_invariants():
    assert_complaint_chat_schema_invariants()
...
def test_oda_havlusu_extracts_room_towel_before_towel_extra():
    ...
    assert extract_request_category_from_text(t) == "hk_towel_change"
