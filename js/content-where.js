...
(function () {
  ...
  var WHERE_I18N = {
    title: {
      ...
      "Çocuk Havuzu": L(
        "Sığ havuz alanı (aquapark)",
        "Shallow pool (aquapark)",
        "Flachbecken (Aquapark)",
        "Мелководье (аквапарк)",
      ),
    ...
    desc: {
      ...
      "Aquapark yanında sığ su alanı": L(
        "Aquapark yanında sığ su alanı",
        "Shallow water by the aquapark",
        "Flaches Wasser neben dem Aquapark",
        "Мелководье у аквапарка",
      ),
  ...
  var POI_DATA = [
    ...
    },
    {
      ...
      yon: "Sağ tarafında",
      desc: "Aquapark yanında sığ su alanı",
    },
    {
      id: 28,
      title: "Aqua Bar",
